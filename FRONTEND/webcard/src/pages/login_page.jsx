    ...
    <div className='login_page_bg h-screen w-screen bg-sky-100 flex justify-center items-center'>
        <div className='login_frame h-2/4 w-4/5 lg:h-2/4 lg:w-2/5 bg-sky-950 rounded-2xl flex flex-col'>
            ...
            <div className='enter_fields flex flex-col justify-center items-center gap-4 h-3/6'>
                <input type='email' className='input_email bg-[#07172e] border border-cyan-700 rounded-lg h-10 lg:w-2/3 placeholder:text-white placeholder:opacity-50' placeholder='E-mail' onChange={(e)=>{setEmail(e.target.value)}}/>
                <input type='password' className='input_pwd bg-[#07172e] border border-cyan-700 rounded-lg h-10 lg:w-2/3 placeholder:text-white placeholder:opacity-50' placeholder='Password' onChange={(e)=>{setPassword(e.target.value)}}/>
            </div>
